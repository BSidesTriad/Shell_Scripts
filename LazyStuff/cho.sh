...
# lazaly chomod the contents of any directory
# rename this script to whatever you want
# mv it to your path,  
# Optional. Be root or not.
...
echo "2) Chown * "   # Wild Card - Change permissions for everyone            
